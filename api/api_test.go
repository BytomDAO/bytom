...
func TestEstimateTxGas(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			wantTotalNeu:    3123000,
			wantFlexibleNeu: 4643400,
		},
		{
		...
		},
		{
			...
			wantTotalNeu:    1037600,
			wantFlexibleNeu: 1429000,
		},
		{
			...
			wantTotalNeu:    1921000,
			wantFlexibleNeu: 2922200,
		},
		{
			...
			wantTotalNeu:    2874200,
			wantFlexibleNeu: 3875400,
		},
	}
