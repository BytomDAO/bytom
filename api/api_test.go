...
func TestEstimateTxGas(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			wantTotalNeu:    3346000,
			wantFlexibleNeu: 4866400,
		},
		{
		...
		},
		{
			...
			wantTotalNeu:    1112200,
			wantFlexibleNeu: 1503600,
		},
		{
			...
			wantTotalNeu:    1980400,
			wantFlexibleNeu: 2981600,
		},
		{
			...
			wantTotalNeu:    2956000,
			wantFlexibleNeu: 3957200,
		},
	}
