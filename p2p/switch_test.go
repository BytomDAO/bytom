...
func TestFiltersOutItself(t *testing.T) {
	...
	cfg.P2P.PrivateKey = string(swPrivKey.Bytes())
...
func TestAddInboundPeer(t *testing.T) {
	...
	inpCfg.P2P.PrivateKey = string(swPrivKey.Bytes())
	...
	rpCfg.P2P.PrivateKey = string(swPrivKey.Bytes())
	...
	inp2Cfg.P2P.PrivateKey = string(swPrivKey.Bytes())
