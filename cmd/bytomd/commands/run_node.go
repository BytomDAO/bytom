...
func init() {
	...
	runNodeCmd.Flags().String("p2p.keep_connect", config.P2P.KeepConnect, "Peers addresses try keeping connecting to")
	runNodeCmd.Flags().String("p2p.inbound_white_list", config.P2P.InboundWhiteList, "Inbound Peer white list")
