...
func init() {
	...
	runNodeCmd.Flags().String("p2p.keep_connect", config.P2P.KeepDial, "Peers addresses try keeping connecting to, separated by ',' (for example \"1.1.1.1:46657;2.2.2.2:46658\")")
