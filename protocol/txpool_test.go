...
func (s *mockStore) CheckpointsFromHeight(uint64) ([]*state.Checkpoint, error)    { return nil, nil }
...
func (s *mockStore) SaveChainStatus(*state.BlockNode, *state.UtxoViewpoint, *state.ContractViewpoint, uint64) error {
	return nil
}
...
func (s *mockStore1) CheckpointsFromHeight(uint64) ([]*state.Checkpoint, error)    { return nil, nil }
...
func (s *mockStore1) SaveChainStatus(*state.BlockNode, *state.UtxoViewpoint, *state.ContractViewpoint, uint64) error { return nil}
