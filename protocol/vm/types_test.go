...
func TestBigIntBytes(t *testing.T) {
	tests := []struct {
		...
		{num: new(big.Int), input: []byte{0x30, 0x78, 0x30}},
		{num: new(big.Int).SetInt64(0), input: []byte{0x30, 0x78, 0x30}},
		{num: new(big.Int).SetInt64(1), input: []byte{0x30, 0x78, 0x31}},
		{num: new(big.Int).SetInt64(255), input: []byte{0x30, 0x78, 0x66, 0x66}},
		{num: new(big.Int).SetInt64(256), input: []byte{0x30, 0x78, 0x31, 0x30, 0x30}},
		{num: new(big.Int).SetInt64(46657), input: []byte{0x30, 0x78, 0x62, 0x36, 0x34, 0x31}},
		{num: new(big.Int).SetInt64(1 << 32), input: []byte{0x30, 0x78, 0x31, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30}},
		{
			num: new(big.Int).Exp(new(big.Int).SetInt64(10), new(big.Int).SetInt64(32), nil),
			input: []byte{0x30, 0x78, 0x34, 0x65, 0x65, 0x32, 0x64, 0x36, 0x64, 0x34, 0x31, 0x35, 0x62, 0x38, 0x35,
				0x61, 0x63, 0x65, 0x66, 0x38, 0x31, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30},
		},
		{num: new(big.Int).SetInt64(-1), input: []byte{0x30, 0x78, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66}},
		{num: new(big.Int).SetInt64(-256), input: []byte{0x30, 0x78, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
			0x30, 0x30}},
