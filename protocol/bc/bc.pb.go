...
type TxHeader struct {
	Version        uint64  `protobuf:"varint,1,opt,name=version" json:"version,omitempty"`
	SerializedSize uint64  `protobuf:"varint,2,opt,name=serialized_size,json=serializedSize" json:"serialized_size,omitempty"`
	MaxTime        uint64  `protobuf:"varint,3,opt,name=max_time,json=maxTime" json:"max_time,omitempty"`
...
func (m *TxHeader) GetMaxTime() uint64 {
	if m != nil {
		return m.MaxTime
	}
	return 0
...
var fileDescriptor0 = []byte{
	...
	,
}
