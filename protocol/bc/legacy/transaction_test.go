...
func TestTransaction(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			hex: (""), // reference data
			hash: mustDecodeHash("346373bc09a06b8bd937ae2ef050d11457604317067b53bc4f621605eca5f603"),
		},
		{
			tx: NewTx(TxData{
				Version:        1,
				SerializedSize: uint64(208),
				Inputs: []*TxInput{
			...
			hex: (""), // output 1, output witness
			hash: mustDecodeHash("067831701eaec7b83008d347e5e90d2f331c9a69c9423c1df676d1e7cdb107d2"),
		},
	}
