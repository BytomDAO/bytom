...
func TestTransactionTrailingGarbage(t *testing.T) {
	...
	validTxHex := `070000010110020e6172626974726172792d746573740001010050ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01012c30303134343433316334323738363332633665333564643238373066616131613462386530613237356362630000`
	validTx := Tx{}
...
func TestFuzzUnknownAssetVersion(t *testing.T) {
	rawTx := `07000001011402126172626974726172792d746573742d3132330001010050ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff64012c30303134343433316334323738363332633665333564643238373066616131613462386530613237356362630000`
	/*
		07
		01
		00
