...
func TestReadWriteOutputCommitment(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			encodeString: "44ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff64011600140876db6ca8f4542a836f0edd42b87d095d0811820a73746174654461746131",
		},
		{
			oc: &OutputCommitment{
			...
			encodeString: "44ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff32011600148bf7800b2333afd8414d6e903d58c4908b9bbcc70a73746174654461746132",
		},
	}
