	...
	cases := []struct {
	...
	}{
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 10000000001, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: true,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707e"), 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 20000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 5000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 20000000000, testutil.MustDecodeHexString("6a"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 5000000000, testutil.MustDecodeHexString("6a"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 0, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Inputs:  []*types.TxInput{},
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 10, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("97575084e5161406a0977da729fbf51ad230e0ff0aec607a97e4336611c8707f"), 100, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, math.MaxUint64, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, math.MaxUint64, testutil.MustDecodeHexString("6a"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(*consensus.BTMAssetID, 18446744073609551616, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(*consensus.BTMAssetID, 290000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: false,
		...
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("bf5f8da2334590ee095148ccdcf4d806b26a47a6d9e9e857ef6c2de79aee4f14"), 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: true,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 9000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
					types.NewTxOutput(testutil.MustDecodeAsset("776f0a421e9176a03061d388aff4ab3b1bcd32e53a090d593a466706c69e3d3f"), 10000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: true,
		},
		{
			...
			txData: types.TxData{
				...
				Outputs: []*types.TxOutput{
					types.NewTxOutput(*consensus.BTMAssetID, 19000000000, testutil.MustDecodeHexString("00145931e1b7b65897f47845ac08fc136e0c0a4ff166"), nil),
				},
			},
			err:      true,
			gasValid: true,
