...
// 	- NTBlockAccepted:     *types.Block
// 	- NTBlockConnected:    *types.Block
// 	- NTBlockDisconnected: *types.Block
...
func (b *Chain) Subscribe(callback NotificationCallback) {
...
// to New.
func (b *Chain) sendNotification(typ NotificationType, data interface{}) {
