...
func NewContract(platformScript []byte, marginFold uint64) ([]byte, error) {
	...
	builder.AddJumpIf(0)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, payAmount, marginAmount]
	builder.AddOp(vm.OP_SWAP)
	builder.AddOp(vm.OP_DUP)
	builder.AddUint64(100)
	builder.AddOp(vm.OP_DIV)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, payAmount, platformFee]
	builder.AddOp(vm.OP_SWAP)
	builder.AddOp(vm.OP_DUP)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, platformFee, payAmount, payAmount]
	cpAltStack(builder, 4)
	builder.AddOp(vm.OP_MUL)
	builder.AddUint64(100)
	builder.AddOp(vm.OP_DIV)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, platformFee, payAmount, createrTax]
	builder.AddOp(vm.OP_DUP)
	builder.AddUint64(2)
	builder.AddOp(vm.OP_SWAP)
	...
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, platformFee, payAmount, createrTax, 2, createrTax, marginAsset, 1, PROGRAM]
	...
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, payAmount-createrTax, platformFee, 3, platformFee, marginAsset, 1, platformScript]
	builder.AddOp(vm.OP_CHECKOUTPUT)
	builder.AddOp(vm.OP_VERIFY)
	builder.AddOp(vm.OP_SUB)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, ownerGot]
	builder.AddOp(vm.OP_DUP)
	cpAltStack(builder, 0)
	builder.AddUint64(marginFold)
	builder.AddOp(vm.OP_MUL)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, ownerGot, ownerGot, marginAmount*marginFold]
	builder.AddOp(vm.OP_GREATERTHANOREQUAL)
	builder.AddOp(vm.OP_VERIFY)
	cpAltStack(builder, 0)
	builder.AddOp(vm.OP_ADD)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, ownerGot+marginAmount]
	builder.AddUint64(4)
	builder.AddOp(vm.OP_SWAP)
	cpAltStack(builder, 1)
	builder.AddUint64(1)
	...
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount, 4, ownerGot+marginAmount, marginAsset, 1, owner]
	builder.AddOp(vm.OP_CHECKOUTPUT)
	builder.AddOp(vm.OP_VERIFY)
	// alt stack	[creater, taxRate, nftAsset, owner, marginAsset, marginAmount]
	// data statck	[buyer, newMarginAmount]
